...
if __name__ == "__main__":
    ...
    if args.use_ms:
        ...
        model_dir = snapshot_download(args.checkpoint_path)
        tokenizer = AutoTokenizer.from_pretrained(model_dir, trust_remote_code=True, resume_download=True)
        model = AutoModelForCausalLM.from_pretrained(model_dir,  device_map=device_map,  trust_remote_code=True, resume_download=True).eval()
        ...
        model = AutoModelForCausalLM.from_pretrained(args.checkpoint_path,  device_map=device_map,  trust_remote_code=True, resume_download=True).eval()
    ...
    #     torch_dtype="auto",
    #     max_memory={0:"14GB",1:"14GB","cpu": "20GB"},
